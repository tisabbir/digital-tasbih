let subhanallahDisplay = document.getElementsByClassName('subhanallahDisplay')[0];

let alhamdulillahDisplay = document.getElementsByClassName('alhamdulillahDisplay')[0];

let AllahAkbarDisplay = document.getElementsByClassName('AllahAkbarDisplay')[0];

let subhanallahIncrement = document.getElementsByClassName('subhanallahIncrement')[0];
let alhamdulillahIncrement = document.getElementsByClassName('alhamdulillahIncrement')[0];
let AllahAkbarIncrement = document.getElementsByClassName('AllahAkbarIncrement')[0];


let subhanallahDecrement = document.getElementsByClassName('subhanallahDecrement')[0];
let alhamdulillahDecrement = document.getElementsByClassName('alhamdulillahDecrement')[0];
let AllahAkbarDecrement = document.getElementsByClassName('AllahAkbarDecrement')[0];
